      ...
      <div className={styles.container}>
        ...
        <div className={styles.responsiveLinks}>
          <div className={styles.responsiveLinksContainer}>
            <button
              className={
                responsiveLinksOpen === true
                  ? `${styles.linksButton} ${styles.linksButtonActive}`
                  : styles.linksButton
              }
              onClick={() => setResponsiveLinksOpen(!responsiveLinksOpen)}
            >
              <p>Links</p>
              <IoMdArrowDropdown />
            </button>
            <div
              className={
                responsiveLinksOpen ? styles.rLinksOpen : styles.rLinks
              }
            >
              {links.map((link, i) => (
                <Link
          ...
          <div className={styles.logout}>
            {isLogged ? (
              <button
                ...
                style={{
                  animationDuration: `${(links.length + 1) * menuItemDelay}s`,
                }}
              ...
              <Login
                mobile
                menuOpen={menuOpen}
                linksLength={links.length + 1}
                delay={menuItemDelay}
                setLoginState={setIsLogged}
                loginState={isLogged}
              />
            )}
          </div>
